...
.format_multisitedgp_summary <- function(x) {
  ...
  c(
    ...
    .format_summary_row(report, "realized_pearson_corr", "copula_latent", "   pearson_corr copula latent"),
    .format_summary_row(report, "raw_pearson_corr", "residual", "   pearson_corr raw residual"),
    .format_summary_row(report, "raw_pearson_corr", "marginal", "   pearson_corr raw marginal"),
    "",
    "C. G shape fit",
...
.summary_report_rows <- function(tab) {
  wanted <- list(
    ...
    c("realized_pearson_corr", "copula_latent"),
    c("raw_pearson_corr", "residual"),
    c("raw_pearson_corr", "marginal"),
