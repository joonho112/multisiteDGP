...
| 4 재현성 계약 | **막힘** (D-019) | — |
| 5 테스트 스위트 | **부분 (3/6 Step)** | [`005_phase05-test-suite-rebuild-partial.html`](005_phase05-test-suite-rebuild-partial.html) |
| 6–11 | 미착수 | — |
...
| 지표 | 시작 | 지금 |
|---|--:|--:|
| git 관리 | 없음 | 627 파일 추적, 커밋 9 건 |
| 기본 테스트 skip | **30** | **1** |
| 기본 테스트 실패 | 0 | 0 |
| 기본 테스트 시간 | 18.1 s | 110.7 s (예산 180 s) |
| 커버리지 | 90.89 % | **92.22 %** |
...
|---|---|
| **D5 만** | Phase 4 · 6 |
| **D3 만** | Phase 5 잔여 3 Step (이미 잠정 적용 중이므로 확인만) |
